---
title: "Sofía Salazar's CV"
author: Sofía Salazar Magaña
date: "`r Sys.Date()`"
params:
  pdf_mode:
    value: true
...
The source code is available [on github.com/SophSM/CV](https://github.com/SophSM/CV).
...
Sofía Guadalupe Salazar Magaña {#title}
--------------------------------------------------------------------------------
...
Posters {data-icon=chalkboard-teacher}
--------------------------------------------------------------------------------
